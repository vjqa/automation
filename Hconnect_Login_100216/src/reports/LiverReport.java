...
public class LiverReport extends BasetestScript {
...
//		viewList.add("22");
	...
	public void LIVER(String Bilirubin,String SGOT,String SGPT,String AlkalinePhosphatase,String Albumin,String Globulin,String TotalProtein,String Note) throws InterruptedException
	{
		...
		inputList.add(Bilirubin);
		inputList.add(SGOT);
		inputList.add(SGPT);
		inputList.add(AlkalinePhosphatase);
		inputList.add(Albumin);
		inputList.add(Globulin);
		inputList.add(TotalProtein);
		inputList.add(Note);
