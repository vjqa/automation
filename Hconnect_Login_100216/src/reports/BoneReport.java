...
public class BoneReport extends BasetestScript {
	...
	public void AddBoneReports() throws IOException, InterruptedException {
		try {
			...
			String parentHandle = driver.getWindowHandle(); // get the current
															// window handle
			driver.findElement(By.id("A1")).click(); // click some link that
														// opens a new window
			...
			Bone.moveToElement(driver.findElement(By
					.xpath(".//*[@id='Service_1216']/p")));
			...
			FileUtils.copyFile(scrFile, new File(
					"D:\\temp\\AddReports\\Add_Bone_Report.jpeg"), true);

			Actions savebutton = new Actions(driver);
			savebutton.moveToElement(driver.findElement(By
	...
	public void BONE(String Calcium, String Phosphorus, String Note)
		...
		inputList.add(Calcium);
		inputList.add(Phosphorus);
		inputList.add(Note);
